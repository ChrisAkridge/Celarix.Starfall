...
{
    public sealed class UnaryPrefixExpression : LibraExpression
    {
        public string Operator { get; set; }
        public LibraExpression Operand { get; set; }

        public UnaryPrefixExpression(string @operator,
            LibraExpression operand,
        ...
        private UnaryPrefixExpression(string @operator,
            LibraExpression operand,
            SColor foregroundColor,
            SColor backgroundColor,
        ...
        protected internal override LibraLayoutResult Layout(LibraRenderingContext context)
        {
            ...
            Console.WriteLine($"In UnaryPrefixExpression.Layout: operand={operand.Bounds}, op={op.Size}, op id={Id.RenderableKey("operator")}");
            ...
            var operandX = op.Bounds.Width + marginWidth;
            var operatorX = 0d;
        ...
        private UnaryPrefixExpression WithChildren(LibraExpression newOperand)
        {
